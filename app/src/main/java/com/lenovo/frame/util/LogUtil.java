...
public class LogUtil {
    ...
    private static final String TAG_VERBOSE         = "<FEIZAI-FRAME> VERBOSE";
    private static final String TAG_DEBUG           = "<FEIZAI-FRAME> DEBUG";
    private static final String TAG_INFO            = "<FEIZAI-FRAME> INFO";
    private static final String TAG_WARN            = "<FEIZAI-FRAME> WARN";
    private static final String TAG_ERROR           = "<FEIZAI-FRAME> ERROR";
    private static final String TAG_METHOD_IN       = "<FEIZAI-FRAME> IN ";
    ...
    private static void logMethod(String methodTag, String content) {
        ...
        if("mercury_demo2".equals(product)) {
            try {
